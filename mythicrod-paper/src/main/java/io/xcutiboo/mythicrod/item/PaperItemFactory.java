...
/**
 * Platform-specific implementation of item creation for Paper
 */
public class PaperItemFactory implements PlatformItemFactory {

    private final Logger logger;
    private final NexoItemProvider nexoProvider;

    public PaperItemFactory(Logger logger) {
        this.logger = logger;
