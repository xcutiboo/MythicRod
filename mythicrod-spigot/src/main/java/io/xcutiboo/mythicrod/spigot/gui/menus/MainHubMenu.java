        ...
        if (getPlayer().hasPermission("mythicrod.admin.reload")) {
            ...
            setItem(49, reloadItem, event -> {
                ...
                try {
                    ...
                    plugin.getLogger().log(java.util.logging.Level.SEVERE, "[MythicRod-MainHubMenu] Critical error during reload from GUI. Configuration may be corrupted. Check file permissions and YAML syntax.", e);
                }
            });
        }
