...
public class MessageFormatter {
    ...
    public Component formatChatMessage(String message) {
        ...
        Component prefixComponent = ConfiguredText.parse(prefix);
        Component messageComponent = ConfiguredText.parse(message);
    ...
    public Component formatTitle(String title) {
        ...
        return ConfiguredText.parse(title);
    }
    ...
    public Component formatItemName(String name) {
        ...
        return ConfiguredText.parse(name);
    }
    ...
    public Component formatLore(String loreLine) {
        ...
        return ConfiguredText.parse(loreLine)
    ...
    public Component formatMessage(String message) {
        ...
        return ConfiguredText.parse(message);
    }
