...
file_path = "mythicrod-common/src/main/java/io/xcutiboo/mythicrod/api/platform/PlatformServer.java"
with open(file_path, "r") as f:
    content = f.read()

# Make sure PlatformServer.java doesn't have duplicate methods or syntax errors
...
print("Fixed PlatformServer.java")
